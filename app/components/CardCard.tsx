        ...
        <div style={{ position: "relative", aspectRatio: "63/88", background: "var(--bg-deep)" }}>
          {imageUrl ? (
            ...
            <div style={{
              ...
              <span style={{ fontSize: "11px", fontFamily: "'Outfit', sans-serif" }}>{card.name}</span>
            </div>
          )}
          ...
          {hovered && (
            <button
              ...
              style={{
                ...
                border: `1px solid ${saved ? "rgba(34,197,94,0.5)" : "rgba(255,255,255,0.18)"}`,
                borderRadius: "50%",
        ...
        <div style={{ padding: "10px 12px 12px" }}>
          ...
          <div style={{ display: "flex", alignItems: "center", justifyContent: "space-between" }}>
            ...
            {(card.power && card.toughness) && (
              <span style={{ fontSize: "11px", color: "var(--text-secondary)", fontFamily: "'Outfit', sans-serif" }}>
                {card.power}/{card.toughness}
              </span>
            )}
          </div>
