    ...
    <div style={{ position: "relative", zIndex: 10 }}>
      ...
      <button
        ...
        style={{
          ...
          gap: "8px",
          padding: "10px 18px",
          background: open ? "rgba(155,107,255,0.12)" : "rgba(22,27,43,0.8)",
          border: `1px solid ${open ? "rgba(155,107,255,0.45)" : "rgba(155,107,255,0.18)"}`,
          borderRadius: "8px",
              ...
              {COLORS.map((c) => (
                <button
                  ...
                  style={{
                    ...
                    background: filters.colors.includes(c.id) ? "rgba(155,107,255,0.12)" : "transparent",
                    cursor: "pointer",
